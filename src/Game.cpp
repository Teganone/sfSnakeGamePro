...
const float Game::BarrierGeneratedTimesMode[] = {3.f,2.f,1.f};
const float Game::MaxLastEatIntervalMode[] = {30.f,10.f,5.f};
const int Game::BarrierNumByMode[] = {0,5,15}; //困难模式对应的Barrier数目
const int Game::speedMode[] = {1,2,3};
const sf::String Game::DifficultyModeStr[]={L"简单",L"中等",L"困难"};
...
sf::VideoMode Game::initVideoMode_()
{
    ...
    return sf::VideoMode(
        desktopMode.width / 4.0f * 3.0f,
        desktopMode.height / 4.0f * 3.0f,
...
// sf::Clock Game::barrierTimer = sf::Clock();
// sf::Time Game::barrierSpawnInterval_ = sf::seconds(Game::BarrierGeneratedTimesMode[Game::DifficultyMode]);
// sf::Clock Game::GameScreenTimer = sf::Clock();
sf::Time  Game::GameScreenTimerPausedTime = sf::Time::Zero;
/* 开局显示帮助
 */
