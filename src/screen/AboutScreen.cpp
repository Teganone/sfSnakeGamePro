...
AboutScreen::AboutScreen()
{
    ...
    text_.setString(
        sf::String(L"这是复旦大学2023年春面向对象程序设计课程大作业\n\n") +
        sf::String(L"项目来源：https://github.com/jhpy1024/sfSnake\n\n") +
        sf::String(L"作者：Teganone(iteganone@gmail.com)\n\n") +
        sf::String(L"参考&&素材来源：https://github.com/JingYiJun/sfSnakePro\n\n"));
