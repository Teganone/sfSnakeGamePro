...
namespace sfSnake
{
    ...
    public:
        ...
        static int DifficultyMode;

        const static int BarrierNumByMode[3];
        const static float BarrierGeneratedTimesMode[3];
        const static float MaxLastEatIntervalMode[3];
        const static int speedMode[3];
        const static sf::String DifficultyModeStr[3];
        ...
        // static sf::Clock GameScreenTimer;
        static sf::Time GameScreenTimerPausedTime;
    ...
    */
    inline float angleCosine(const sf::Vector2f& vec1,const sf::Vector2f& vec2) noexcept
    {
